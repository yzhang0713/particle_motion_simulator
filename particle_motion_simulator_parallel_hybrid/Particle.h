...
private:
    ...
    double radius;
public:
    Particle(int id) : particle_id(id), pos(Vector{}), vel(Vector{}), radius(0.0) {

    }
    Particle(int id, Vector pos, Vector vel, double radius) : particle_id(id), pos(Vector(pos)), vel(Vector(vel)), radius(radius) {
